  ...
  "node_modules/react/cjs/react.development.js"(exports) {
    ...
    if (true) {
      (function() {
        ...
        function warnIfStringRefCannotBWatertoConverted(config) {
          {
        ...
        function createElement4(type, config, children) {
          ...
          if (config != null) {
            if (hasValidRef(config)) {
              ref = config.ref;
              {
                warnIfStringRefCannotBWatertoConverted(config);
              }
            }
...
var TableEditor = ({ leafId, cursor, inputData, updateViewData, supressNotices = false }) => {
  ...
  const computWatertoFocusRow = React4.useCallback((values2) => {
